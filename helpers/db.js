/*
This module provides helper methods to allow the application to open and close connections with a MongoDB database.
*/
...
DB.prototype.connect = function() {
	...
	var uri = config.client.mongodb.defaultUri;
